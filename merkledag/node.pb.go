...
func init() {
	proto.RegisterType((*PBLink)(nil), "merkledag.PBLink")
	proto.RegisterType((*PBNode)(nil), "merkledag.PBNode")
}
...
var fileDescriptor_0c843d59d2d938e7 = []byte{
	...
	,
	...
	0x8e, 0xf1, 0xc1, 0x23, 0x39, 0x46, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf6, 0x0b, 0x6a, 0x59,
	0x03, 0x01, 0x00, 0x00,
}
...
func (this *PBLink) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&merkledag.PBLink{")
	if this.Hash != nil {
		s = append(s, "Hash: "+valueToGoStringNode(this.Hash, "byte")+",\n")
	}
	if this.Name != nil {
		s = append(s, "Name: "+valueToGoStringNode(this.Name, "string")+",\n")
	}
	if this.Tsize != nil {
		s = append(s, "Tsize: "+valueToGoStringNode(this.Tsize, "uint64")+",\n")
	}
...
func (this *PBNode) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&merkledag.PBNode{")
	if this.Links != nil {
		s = append(s, "Links: "+fmt.Sprintf("%#v", this.Links)+",\n")
	}
	if this.Data != nil {
		s = append(s, "Data: "+valueToGoStringNode(this.Data, "byte")+",\n")
	}
	if this.XXX_unrecognized != nil {
		s = append(s, "XXX_unrecognized:"+fmt.Sprintf("%#v", this.XXX_unrecognized)+",\n")
	}
